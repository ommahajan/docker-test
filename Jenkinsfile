node {
	    ...
	    stage('Deploy Docker Image'){
		  ...
		  sh "docker rm docker-test"
		    ...
		    sh "docker run --restart=always -v /var/run/docker.sock:/var/run/docker.sock \ -v ${which docker}:/usr/bin/docker --name docker-test -d -p 9011:9011 docker-test:${env.BUILD_NUMBER}"
